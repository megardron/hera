...
var args40132 = [];
var len__26143__auto___40138 = arguments.length;
var i__26144__auto___40139 = (0);
while(true){
if((i__26144__auto___40139 < len__26143__auto___40138)){
args40132.push((arguments[i__26144__auto___40139]));

var G__40140 = (i__26144__auto___40139 + (1));
i__26144__auto___40139 = G__40140;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox40135 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40135 = (function (obj,header,style,tag,meta40136){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40135.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40137,meta40136__$1){
var self__ = this;
var _40137__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40135(self__.obj,self__.header,self__.style,self__.tag,meta40136__$1));
});

devtools.toolbox.t_devtools$toolbox40135.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40137){
var self__ = this;
var _40137__$1 = this;
return self__.meta40136;
});

devtools.toolbox.t_devtools$toolbox40135.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40135.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40135.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40135.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40135.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40136","meta40136",-2014422162,null)], null);
});

devtools.toolbox.t_devtools$toolbox40135.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40135.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40135";

devtools.toolbox.t_devtools$toolbox40135.cljs$lang$ctorPrWriter = (function (this__25674__auto__,writer__25675__auto__,opt__25676__auto__){
return cljs.core._write.call(null,writer__25675__auto__,"devtools.toolbox/t_devtools$toolbox40135");
});

devtools.toolbox.__GT_t_devtools$toolbox40135 = (function devtools$toolbox$__GT_t_devtools$toolbox40135(obj__$1,header__$1,style__$1,tag__$1,meta40136){
return (new devtools.toolbox.t_devtools$toolbox40135(obj__$1,header__$1,style__$1,tag__$1,meta40136));
});

}

return (new devtools.toolbox.t_devtools$toolbox40135(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1488653213636
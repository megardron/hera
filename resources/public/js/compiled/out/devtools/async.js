...
var o__37217__auto___40393 = (function (){var o__37217__auto__ = (function (){var o__37217__auto__ = Promise;
return goog.object.get(o__37217__auto__,"resolve").call(o__37217__auto__);
})();
return goog.object.get(o__37217__auto__,"then").call(o__37217__auto__,callback);
})();
goog.object.get(o__37217__auto___40393,"catch").call(o__37217__auto___40393,devtools.async.rethrow_outside_promise);
...
var G__40395_40396 = Error;
var target__37236__auto___40397 = G__40395_40396;
if(cljs.core.truth_(target__37236__auto___40397)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__40395_40396)].join('')),cljs.core.str("\n"),cljs.core.str("target__37236__auto__")].join('')));
}

goog.object.set(target__37236__auto___40397,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1488653213926
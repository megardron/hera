...
var reader = (function (){var or__25068__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__25068__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__40420__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40420__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40420__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40419){var _e = e40419;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40422 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40422)){
var seen_errors_40423 = temp__4655__auto___40422;
if(cljs.core.truth_(seen_errors_40423.has(self))){
} else {
seen_errors_40423.add(self);

var temp__4657__auto___40424 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40424)){
var sense_40425 = temp__4657__auto___40424;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40425)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1488653214043
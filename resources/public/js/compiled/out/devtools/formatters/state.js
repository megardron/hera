...
var len__26143__auto___39653 = arguments.length;
var i__26144__auto___39654 = (0);
while(true){
if((i__26144__auto___39654 < len__26143__auto___39653)){
args__26150__auto__.push((arguments[i__26144__auto___39654]));

var G__39655 = (i__26144__auto___39654 + (1));
i__26144__auto___39654 = G__39655;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26151__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq39651){
var G__39652 = cljs.core.first.call(null,seq39651);
var seq39651__$1 = cljs.core.next.call(null,seq39651);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__39652,seq39651__$1);
});
...
return (function (p1__39656_SHARP_){
return (p1__39656_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1488653212759
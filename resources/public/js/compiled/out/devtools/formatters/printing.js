...
var len__26143__auto___39662 = arguments.length;
var i__26144__auto___39663 = (0);
while(true){
if((i__26144__auto___39663 < len__26143__auto___39662)){
args__26150__auto__.push((arguments[i__26144__auto___39663]));

var G__39664 = (i__26144__auto___39663 + (1));
i__26144__auto___39663 = G__39664;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26151__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39659){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39660,G__39661,seq39659__$2);
});
...
if(cljs.core.truth_((function (){var or__25068__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25674__auto__,writer__25675__auto__,opt__25676__auto__){
return cljs.core._write.call(null,writer__25675__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25056__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25056__auto__){
var or__25068__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39665_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__39665_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__39674__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25068__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39678){var e__37242__auto__ = e39678;
return false;
}})();
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
...
}catch (e39680){var e__37242__auto__ = e39680;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39685 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39686 = opts;
...
var markup_db = cljs.core.get.call(null,map__39686__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39685;
}});
...
;
var temp__4655__auto___39691 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39691)){
var managed_print_level_39692 = temp__4655__auto___39691;
var _STAR_print_level_STAR_39690_39693 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39692;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39690_39693,managed_print_level_39692,temp__4655__auto___39691,writer,opts,job_fn){
return (function (p1__39688_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39688_SHARP_,null);
});})(_STAR_print_level_STAR_39690_39693,managed_print_level_39692,temp__4655__auto___39691,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39690_39693;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1488653212865
...
var G__39621 = devtools.prefs.pref.call(null,v);
v = G__39621;
continue;
} else {
return v;
...
var and__25056__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25056__auto__){
var and__25056__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25068__auto__ = (function (){try{if(!((value == null))){
...
}catch (e39634){var e__37242__auto__ = e39634;
return false;
}})();
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
} else {
var or__25068__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e39638){var e__37242__auto__ = e39638;
return false;
}})();
...
}catch (e39640){var e__37242__auto__ = e39640;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25056__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25056__auto__)){
var and__25056__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25056__auto____$1){
...
var and__25056__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25056__auto__)){
...
var or__25068__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
} else {
...
var and__25056__auto__ = (function (){var or__25068__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25068__auto__)){
return or__25068__auto__;
} else {
...
var vec__39645 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39645,(0),null);
var name = cljs.core.nth.call(null,vec__39645,(1),null);
...
var and__25056__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25056__auto__)){
...
var or__25068__auto__ = typeof value === 'string';
if(or__25068__auto__){
return or__25068__auto__;
} else {
var or__25068__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39648_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39648_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1488653212720
...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25674__auto__,writer__25675__auto__,opt__25676__auto__){
return cljs.core._write.call(null,writer__25675__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__26834 = o;
(G__26834[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26835__delegate = function (args){
...
while (G__26836__i < G__26836__a.length) {G__26836__a[G__26836__i] = arguments[G__26836__i + 0]; ++G__26836__i;}
  args = new cljs.core.IndexedSeq(G__26836__a,0);
} 
return G__26835__delegate.call(this,args);};
G__26835.cljs$lang$maxFixedArity = 0;
G__26835.cljs$lang$applyTo = (function (arglist__26837){
var args = cljs.core.seq(arglist__26837);
return G__26835__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__25056__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25056__auto__){
var and__25056__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__26843 = jsprops;
(G__26843["defaultValue"] = value);

(G__26843["onChange"] = ((function (G__26843,v,value,on_change){
return (function (p1__26840_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26840_SHARP_);
});})(G__26843,v,value,on_change))
);

(G__26843["ref"] = ((function (G__26843,v,value,on_change){
return (function (p1__26841_SHARP_){
return (this$["cljsInputElement"] = p1__26841_SHARP_);
});})(G__26843,v,value,on_change))
);
...
var vec__26850 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26850,(0),null);
var id = cljs.core.nth.call(null,vec__26850,(1),null);
var class$ = cljs.core.nth.call(null,vec__26850,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26855 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26855 == null)){
} else {
var key_26856 = temp__4661__auto___26855;
...
var G__26858 = (new reagent.impl.template.NativeWrapper());
(G__26858["name"] = c);
...
var len__26143__auto___26864 = arguments.length;
var i__26144__auto___26865 = (0);
while(true){
if((i__26144__auto___26865 < len__26143__auto___26864)){
args__26150__auto__.push((arguments[i__26144__auto___26865]));

var G__26866 = (i__26144__auto___26865 + (1));
i__26144__auto___26865 = G__26866;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26151__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26862){
var G__26863 = cljs.core.first.call(null,seq26862);
var seq26862__$1 = cljs.core.next.call(null,seq26862);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26863,seq26862__$1);
});
...
break;
default:
var G__26870 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26870;
continue;
...
var n__25983__auto___26873 = a.length;
var i_26874 = (0);
while(true){
if((i_26874 < n__25983__auto___26873)){
(a[i_26874] = reagent.impl.template.as_element.call(null,(a[i_26874])));

var G__26875 = (i_26874 + (1));
i_26874 = G__26875;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25983__auto___26876 = a.length;
var i_26877 = (0);
while(true){
if((i_26877 < n__25983__auto___26876)){
var val_26878 = (a[i_26877]);
if((cljs.core.vector_QMARK_.call(null,val_26878)) && ((reagent.impl.template.key_from_vec.call(null,val_26878) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26877] = reagent.impl.template.as_element.call(null,val_26878));

var G__26879 = (i_26877 + (1));
i_26877 = G__26879;
continue;
} else {
}
...
var ctx = ({});
var vec__26883 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26883,(0),null);
var derefed = cljs.core.nth.call(null,vec__26883,(1),null);
...
var G__26887 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26887) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26887){
...
//# sourceMappingURL=template.js.map?rel=1488653197845
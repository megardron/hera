...
return [cljs.core.str((function (){var pred__27030 = cljs.core.instance_QMARK_;
var expr__27031 = reactive_val;
if(cljs.core.truth_(pred__27030.call(null,reagent.ratom.RAtom,expr__27031))){
return "ra";
} else {
if(cljs.core.truth_(pred__27030.call(null,reagent.ratom.RCursor,expr__27031))){
return "rc";
} else {
if(cljs.core.truth_(pred__27030.call(null,reagent.ratom.Reaction,expr__27031))){
return "rx";
} else {
if(cljs.core.truth_(pred__27030.call(null,reagent.ratom.Track,expr__27031))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1488653198096
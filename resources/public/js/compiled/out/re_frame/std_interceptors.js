...
var vec__27524_27527 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_27528 = cljs.core.nth.call(null,vec__27524_27527,(0),null);
var only_after_27529 = cljs.core.nth.call(null,vec__27524_27527,(1),null);
var db_changed_QMARK__27530 = (cljs.core.some_QMARK_.call(null,only_before_27528)) || (cljs.core.some_QMARK_.call(null,only_after_27529));
if(db_changed_QMARK__27530){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_27528);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_27529);
...
var map__27537 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__27537__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__27537__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27545 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__27545__$1;
var event = cljs.core.get.call(null,map__27545__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26143__auto___27548 = arguments.length;
var i__26144__auto___27549 = (0);
while(true){
if((i__26144__auto___27549 < len__26143__auto___27548)){
args__26150__auto__.push((arguments[i__26144__auto___27549]));

var G__27550 = (i__26144__auto___27549 + (1));
i__26144__auto___27549 = G__27550;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26151__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq27547){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27547));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25068__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26150__auto__ = [];
var len__26143__auto___27556 = arguments.length;
var i__26144__auto___27557 = (0);
while(true){
if((i__26144__auto___27557 < len__26143__auto___27556)){
args__26150__auto__.push((arguments[i__26144__auto___27557]));

var G__27558 = (i__26144__auto___27557 + (1));
i__26144__auto___27557 = G__27558;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26151__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__27551_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__27552_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__27552_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq27553){
var G__27554 = cljs.core.first.call(null,seq27553);
var seq27553__$1 = cljs.core.next.call(null,seq27553);
var G__27555 = cljs.core.first.call(null,seq27553__$1);
var seq27553__$2 = cljs.core.next.call(null,seq27553__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__27554,G__27555,seq27553__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1488653199080